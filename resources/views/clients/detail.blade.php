            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-slate-200">
                    ...
                    <tbody class="bg-white divide-y divide-slate-200">
                        ...
                        @empty
                        <tr>
                            <td colspan="5" class="px-6 py-4 text-center text-sm text-slate-500">Belum ada invoice untuk client ini.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-slate-200">
                    ...
                    <tbody class="bg-white divide-y divide-slate-200">
                        ...
                        @empty
                        <tr>
                            <td colspan="5" class="px-6 py-4 text-center text-sm text-slate-500">Belum ada penawaran untuk client ini.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
