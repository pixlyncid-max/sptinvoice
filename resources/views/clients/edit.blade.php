...
@section('title', 'Edit Client: ' . $client->nama)
        ...
        <div class="px-4 py-5 sm:p-6">
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div class="col-span-1">
                    ...
                    <input type="text" name="perusahaan" id="perusahaan" value="{{ old('perusahaan', $client->perusahaan) }}" class="mt-1 focus:ring-primary focus:border-primary block w-full shadow-sm sm:text-sm border-slate-300 rounded-md py-2 px-3 border @error('perusahaan') border-red-500 @enderror" required>
                    @error('perusahaan')
                ...
                <div class="col-span-1">
                    ...
                    <input type="text" name="nama" id="nama" value="{{ old('nama', $client->nama) }}" class="mt-1 focus:ring-primary focus:border-primary block w-full shadow-sm sm:text-sm border-slate-300 rounded-md py-2 px-3 border @error('nama') border-red-500 @enderror">
                    @error('nama')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="col-span-1">
                    ...
                    <select name="jenis_pekerjaan" id="jenis_pekerjaan" class="mt-1 focus:ring-primary focus:border-primary block w-full shadow-sm sm:text-sm border-slate-300 rounded-md py-2 px-3 border @error('jenis_pekerjaan') border-red-500 @enderror" required>
                        <option value="Satuan" {{ old('jenis_pekerjaan', $client->jenis_pekerjaan ?? 'Satuan') == 'Satuan' ? 'selected' : '' }}>Satuan</option>
                        <option value="Bulanan" {{ old('jenis_pekerjaan', $client->jenis_pekerjaan) == 'Bulanan' ? 'selected' : '' }}>Bulanan</option>
                        <option value="Tahunan" {{ old('jenis_pekerjaan', $client->jenis_pekerjaan) == 'Tahunan' ? 'selected' : '' }}>Tahunan</option>
                    </select>
                ...
                <div class="col-span-1">
                    ...
                    <select name="status" id="status" class="mt-1 focus:ring-primary focus:border-primary block w-full shadow-sm sm:text-sm border-slate-300 rounded-md py-2 px-3 border @error('status') border-red-500 @enderror" required>
                        <option value="Aktif" {{ old('status', $client->status ?? 'Aktif') == 'Aktif' ? 'selected' : '' }}>Aktif</option>
                        <option value="Non Aktif" {{ old('status', $client->status) == 'Non Aktif' ? 'selected' : '' }}>Non Aktif</option>
                ...
                <div class="col-span-1">
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email', $client->email) }}" class="mt-1 focus:ring-primary focus:border-primary block w-full shadow-sm sm:text-sm border-slate-300 rounded-md py-2 px-3 border @error('email') border-red-500 @enderror">
                    @error('email')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="col-span-1">
                    ...
                    <input type="text" name="telepon" id="telepon" value="{{ old('telepon', $client->telepon) }}" class="mt-1 focus:ring-primary focus:border-primary block w-full shadow-sm sm:text-sm border-slate-300 rounded-md py-2 px-3 border @error('telepon') border-red-500 @enderror">
                    @error('telepon')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="alamat" id="alamat" rows="3" class="mt-1 focus:ring-primary focus:border-primary block w-full shadow-sm sm:text-sm border-slate-300 rounded-md py-2 px-3 border @error('alamat') border-red-500 @enderror">{{ old('alamat', $client->alamat) }}</textarea>
                    @error('alamat')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
